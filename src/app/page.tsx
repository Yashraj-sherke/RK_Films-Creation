  ...
  return (
    <section ref={ref} className="relative h-screen min-h-[700px] overflow-hidden">
      ...
      >
        ...
        >
          <p className="font-accent text-[11px] md:text-[12px] tracking-[6px] uppercase text-gold mb-6">
        ...
        <motion.h1
          ...
          className="font-display text-5xl md:text-7xl lg:text-8xl xl:text-9xl leading-[0.9] text-warm-white max-w-5xl"
        >
          We Capture
        ...
        <motion.p
          ...
          className="mt-8 max-w-lg text-warm-white/60 text-base md:text-lg font-light leading-relaxed"
        >
          ...
          {services.slice(0, 8).map((service, i) => (
            ...
            >
              <Link href={`/services/${service.id}`}>
                <div className="group relative overflow-hidden bg-black-medium border border-white/5 hover:border-gold/30 transition-all duration-500 h-full">
                  {/* Image */}
                  <div className="relative h-48 overflow-hidden">
                    <div
                      className="absolute inset-0 bg-cover bg-center transition-transform duration-700 group-hover:scale-110"
                      style={{
                        backgroundImage: `url('https://images.unsplash.com/photo-1519741497674-611481863552?w=600&q=60')`,
                      }}
                    />
                  ...
                  <div className="p-6">
                    ...
                    <p className="text-warm-white/40 text-sm leading-relaxed line-clamp-2">
                      {service.description}
                    </p>
        ...
        <div className="grid grid-cols-2 md:grid-cols-3 gap-3 md:gap-4">
          {portfolioImages.map((img, i) => (
            ...
            >
              ...
              <div className="relative z-10 h-full min-h-[200px] md:min-h-[280px] flex flex-col justify-end p-5 opacity-0 group-hover:opacity-100 transition-opacity duration-500">
      ...
      <div className="container-luxury">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          {reasons.map((reason, i) => (
            ...
            >
              <div className="w-16 h-16 mx-auto mb-5 border border-gold/30 flex items-center justify-center text-gold group-hover:bg-gold group-hover:text-black transition-all duration-400">
                {reason.icon}
              </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {testimonials.slice(0, 3).map((t, i) => (
            <motion.div
              ...
              viewport={{ once: true }}
              transition={{ duration: 0.5, delay: i * 0.1 }}
              className="glass p-8 hover:border-gold/20 transition-all duration-500 group"
            >
              <Quote
                size={24}
      ...
      <div className="container-luxury">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 relative">
          ...
          {processSteps.map((step, i) => (
            ...
            >
              <div className="w-24 h-24 mx-auto mb-6 border border-gold/30 rounded-full flex items-center justify-center bg-black-light relative z-10">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 max-w-5xl mx-auto">
          {pricingPlans.map((plan, i) => (
            <motion.div
              ...
              viewport={{ once: true }}
              transition={{ duration: 0.5, delay: i * 0.1 }}
              className={`relative p-8 border transition-all duration-500 hover:border-gold/30 ${
                plan.popular
